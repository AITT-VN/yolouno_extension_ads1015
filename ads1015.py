...
class ADS1015(ADS1115):
    ...
    def raw_to_v(self, channel1=0, rate=4):
        raw = self.read(rate=rate, channel1=channel1)
        v_p_b = _GAINS_V[self.gain] / 2048  # Vì ADS1015 là 12-bit => 2^11 = 2048 bước
        return raw * v_p_b
...
ads1015 = ADS1015(i2c, address=0x48, gain = 1)
